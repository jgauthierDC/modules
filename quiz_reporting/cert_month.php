...
$result = db_query("SELECT *
  FROM {quiz_reporting_saved_stats_month}
...
<div style="height: 300px; width: 500px; position: relative;" id="ThisCertMonth" class="jqplot-target">
<script type="text/javascript">
	$(document).ready(function(){
		...
		var plot1 = jQuery.jqplot ('ThisCertMonth', [data], 
		{ 
		  title:'This Month\'s Registrants ' + '(<?php print $total; ?>)' ,
		  seriesDefaults: {
